	...
	public JSONDeviceConfigImpl(JSONObject object) {
		if (object.get(JSONApiResponseKeysEnum.DEVICE_GET_CONFIG_CLASS.getKey()) != null) {
			try {
				...
				//logger.error
				System.err.println("NumberFormatException by getting class: "+object.get(JSONApiResponseKeysEnum.DEVICE_GET_CONFIG_CLASS.getKey()).toString());
			}
		}
		...
		if (object.get(JSONApiResponseKeysEnum.DEVICE_GET_CONFIG_INDEX.getKey()) != null) {
			try {
				...
				//logger.error
				System.err.println("NumberFormatException by getting index: "+object.get(JSONApiResponseKeysEnum.DEVICE_GET_CONFIG_INDEX.getKey()).toString());
			}
		}
		...
		if (object.get(JSONApiResponseKeysEnum.DEVICE_GET_CONFIG_VALUE.getKey()) != null) {
			try {
				...
				//logger.error
				System.err.println("NumberFormatException by getting value: "+object.get(JSONApiResponseKeysEnum.DEVICE_GET_CONFIG_VALUE.getKey()).toString());
			}
		}
