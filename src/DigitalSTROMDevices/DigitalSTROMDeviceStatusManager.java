...
import DigitalSTROMDevices.DeviceParameters.CachedMeteringValue;
...
import DigitalSTROMDevices.DeviceParameters.MeteringTypeEnum;
import DigitalSTROMDevices.DeviceParameters.MeteringUnitsEnum;
import DigitalSTROMDevices.DeviceParameters.OutputModeEnum;
import DigitalSTROMDevices.DeviceParameters.SensorIndexEnum;
import DigitalSTROMSensorJobExecuter.SceneSensorJobExecutor;
import DigitalSTROMSensorJobExecuter.SensorJobExecutor;
import DigitalSTROMSensorJobExecuter.SensorJob.DeviceConsumptionSensorJob;
import DigitalSTROMSensorJobExecuter.SensorJob.DeviceOutputValueSensorJob;
import DigitalSTROMSensorJobExecuter.SensorJob.SceneConfigSensorJob;
import DigitalSTROMSensorJobExecuter.SensorJob.SceneOutputValueSensorJob;
...
import Scenes.Scene.SceneManagerImpl;
import Scenes.SceneHandler.SceneStatusListener;

public class DigitalSTROMDeviceStatusManager {
	...
	private static final int POLLING_FREQUENCY = 1; // in seconds
	...
	public DigitalSTROMDeviceStatusManager(String host, String user, String password, String appToken){
		...
		this.strucMan = new DigitalSTROMStructureManager();
		this.sceneMan = new SceneManagerImpl(connMan, strucMan);
	}
	
	public DigitalSTROMDeviceStatusManager(DigitalstromConnectionManager connMan,DigitalSTROMStructureManager strucMan, 
	...
	public DigitalSTROMDeviceStatusManager(DigitalstromConnectionManager connMan){
		this.connMan = connMan;
		this.digitalSTROMClient = connMan.getDigitalSTROMAPI();
		this.strucMan = new DigitalSTROMStructureManager();
		this.sceneMan = new SceneManagerImpl(connMan, strucMan);
	...
	private Runnable pollingRunnable = new Runnable() {
        ...
        public void run() {
        	if(connMan.checkConnection()){
        		...
        		HashMap<DSID, Device> tempDeviceMap = new HashMap<DSID, Device>(strucMan.getDeviceMap());
	        	...
	        	if(totalPowerConsumptionListener != null){
	        		...
	        		totalPowerConsumptionListener.onTotalPowerConsumptionChanged(tempConsumtion);
	        	}
	...
	class TrashDevice {
		...
		public boolean isTimeToDelete(int dayOfYear){
			return this.timeStamp + DigitalSTROMConfig.DEFAULT_TRASH_DEVICE_DELEATE_TIME <= dayOfYear; 
		}
