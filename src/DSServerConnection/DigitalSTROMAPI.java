...
public interface DigitalSTROMAPI {
	...
	boolean undoApartmentScene(String token, int groupID, String groupName,
			Scene sceneNumber);

	boolean undoZoneScene(String token, int zoneID, String zoneName,
			int groupID, String groupName, ZoneSceneEnum sceneNumber);
