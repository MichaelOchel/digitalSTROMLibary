 ...
 */
package digitalSTROMStructure.digitalSTROMDevices.impl;
...
public class JSONDeviceImpl implements Device {
	...
	public boolean isPowerConsumptionUpToDate(){
		return isOn && !isRollershutter() && !this.powerConsumptionRefreshPriority.contains(DigitalSTROMConfig.REFRESH_PRIORITY_NEVER) ?
	...
	public boolean isElectricMeterUpToDate(){
		return isOn && !isRollershutter() && !this.electricMeterRefreshPriority.contains(DigitalSTROMConfig.REFRESH_PRIORITY_NEVER) ?
	...
	public boolean isEnergyMeterUpToDate(){
		return isOn && !isRollershutter() && !this.energyMeterRefreshPriority.contains(DigitalSTROMConfig.REFRESH_PRIORITY_NEVER) ?
	...
	private void setCachedMeterData(){
		...
		if(cachedSensorData != null){
			if(cachedSensorData[0] != null && !this.powerConsumptionRefreshPriority.contains(DigitalSTROMConfig.REFRESH_PRIORITY_NEVER)){
			...
			if(cachedSensorData[1] != null && !this.electricMeterRefreshPriority.contains(DigitalSTROMConfig.REFRESH_PRIORITY_NEVER)){
			...
			if(cachedSensorData[2] != null && !this.energyMeterRefreshPriority.contains(DigitalSTROMConfig.REFRESH_PRIORITY_NEVER)){
