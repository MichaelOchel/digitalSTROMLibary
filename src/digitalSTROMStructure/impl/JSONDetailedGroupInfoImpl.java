package digitalSTROMStructure.impl;
/**
	...
	public JSONDetailedGroupInfoImpl(JSONObject jObject) {
		...
		if (jObject.get(JSONApiResponseKeysEnum.GROUP_ID.getKey()) != null) {
			try {
				...
				//logger.error
				System.err.println("NumberFormatException by parsing groupID: "+ jObject.get(JSONApiResponseKeysEnum.GROUP_ID.getKey()).toString());
			}
		}
