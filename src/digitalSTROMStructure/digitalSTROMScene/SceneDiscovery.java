...
public class SceneDiscovery {
	...
	public SceneDiscovery(DigitalSTROMSceneManager sceneManager){ //DigitalstromConnectionManager connectionManager, DigitalSTROMStructureManager structureManager
	...
	public void generateAllScenes(DigitalstromConnectionManager connectionManager, DigitalSTROMStructureManagerImpl structureManager){
	...
	public void generateAppartmentScence(){
		for(digitalSTROMStructure.digitalSTROMScene.constants.ApartmentSceneEnum apartmentScene : ApartmentSceneEnum.values()){
	...
	public boolean  generateReachableScenes(DigitalstromConnectionManager connectionManager, DigitalSTROMStructureManagerImpl structureManager){
		HashMap<Integer, List<Short>> reachableGroups = getReachableGroups(connectionManager);
